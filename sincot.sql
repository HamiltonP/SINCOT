...
-- Tiempo de generación: 04-05-2019 a las 17:29:03
...
INSERT INTO `usuario` (`idusuario`, `nombre`, `apellido`, `numero_ide`, `correo_electronico`, `username`, `password`, `token`, `validacion`) VALUES
(1, 'alberto', 'martinez', 1013456765, 'alberto@martinez.com', 'admin', '12345', NULL, 0),
(2, 'SEBASTIAN ', 'MONTANA', 1233509976, 'dj.sebas.montana@gmail.com', 'sebas', '123456', NULL, 0);
